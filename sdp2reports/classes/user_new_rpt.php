...
/**
 * Page class (user_new_rpt)
 */
class user_new_rpt extends user_new_base
{
	...
	// Page object name
	public $PageObjName = 'user_new_rpt';
	public $Token = "";
	...
	public function __construct()
	{
		...
		// Table object (user_new_base)
		if (!isset($GLOBALS["user_new_base"])) {
			$GLOBALS["user_new_base"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["user_new_base"];
		}
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'user_new');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fuser_newrpt";
	...
	protected function setupExportOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fuser_newrpt\" href=\"#\">" . $ReportLanguage->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fuser_newrpt\" href=\"#\">" . $ReportLanguage->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $ReportLanguage->phrase("SearchBtn", TRUE) . "\" data-caption=\"" . $ReportLanguage->phrase("SearchBtn", TRUE) . "\" data-toggle=\"button\" data-form=\"fuser_newrpt\">" . $ReportLanguage->phrase("SearchBtn") . "</button>";
		$item->Visible = FALSE;
	...
	public function loadRowValues($firstRow = FALSE)
	{
		...
		if (!$this->Recordset->EOF) {
			...
			$this->Values[4] = $this->email_id->CurrentValue;
			$this->Values[5] = $this->phone_number->CurrentValue;
			$this->Values[6] = $this->password->CurrentValue;
			$this->Values[7] = $this->pincode->CurrentValue;
		} else {
