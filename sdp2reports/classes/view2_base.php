...
class view2_base extends ReportTable
{
	...
	public function __construct()
	{
		...
		// order_id
		$this->order_id = new ReportField('view2_base', 'view2', 'x_order_id', 'order_id', '`order_id`', 3, -1, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// product_name
		$this->product_name = new ReportField('view2_base', 'view2', 'x_product_name', 'product_name', '`product_name`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->product_name->Sortable = TRUE; // Allow sort
		$this->product_name->DateFilter = "";
		$this->fields['product_name'] = &$this->product_name;

		// order_date
		$this->order_date = new ReportField('view2_base', 'view2', 'x_order_date', 'order_date', '`order_date`', 133, 0, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// user_name
		$this->user_name = new ReportField('view2_base', 'view2', 'x_user_name', 'user_name', '`user_name`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_name->Sortable = TRUE; // Allow sort
		$this->user_name->DateFilter = "";
		$this->fields['user_name'] = &$this->user_name;

		// order_status
		$this->order_status = new ReportField('view2_base', 'view2', 'x_order_status', 'order_status', '`order_status`', 200, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->order_status->Sortable = TRUE; // Allow sort
		$this->order_status->DateFilter = "";
		$this->order_status->Lookup = new ReportLookup('order_status', 'view2_base', TRUE, 'order_status', ["order_status","","",""], [], [], [], [], [], [], '`order_status` ASC', '');
		$this->order_status->Lookup->RenderViewFunc = "renderLookup";
		$this->fields['order_status'] = &$this->order_status;

		// order_amount
		$this->order_amount = new ReportField('view2_base', 'view2', 'x_order_amount', 'order_amount', '`order_amount`', 131, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->order_amount->Sortable = TRUE; // Allow sort
		$this->order_amount->DefaultErrorMessage = $ReportLanguage->phrase("IncorrectFloat");
		$this->order_amount->DateFilter = "";
		$this->fields['order_amount'] = &$this->order_amount;

		// quantity
		$this->quantity = new ReportField('view2_base', 'view2', 'x_quantity', 'quantity', '`quantity`', 3, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// price
		$this->price = new ReportField('view2_base', 'view2', 'x_price', 'price', '`price`', 131, -1, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->price->Lookup = new ReportLookup('price', 'view2_base', TRUE, 'price', ["price","","",""], [], [], [], [], [], [], '`price` ASC', '');
	...
	public function renderPopup()
	{
		...
		if ($this->order_status->CurrentValue === NULL) // Handle null value
			$this->order_status->ViewValue = $ReportLanguage->phrase("NullLabel");
		elseif ($this->order_status->CurrentValue == "") // Handle empty value
			$this->order_status->ViewValue = $ReportLanguage->phrase("EmptyLabel");
		else
