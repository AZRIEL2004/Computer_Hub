...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'NLgxB66wgc2pet2b'); // Random key for encryption
...
$PROJECT_ID = "{ED11F992-8AFB-43A9-BB59-321AE3AEE5CF}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "sdp2", "qs" => "`", "qe" => "`");
