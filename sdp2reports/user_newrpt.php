...
// Create page object
if (!isset($user_new_rpt))
	$user_new_rpt = new user_new_rpt();
if (isset($Page))
	$OldPage = $Page;
$Page = &$user_new_rpt;
...
<div id="ew-center" class="<?php echo $user_new_rpt->CenterContentClass ?>">
<?php } ?>
...
<!-- Report grid (begin) -->
<?php if ($Page->Export <> "pdf") { ?>
<div id="gmp_user_new" class="<?php if (IsResponsiveLayout()) { echo "table-responsive "; } ?>ew-grid-middle-panel">
<?php } ?>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="user_id"><div class="user_new_user_id"><span class="ew-table-header-caption"><?php echo $Page->user_id->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="user_id">
<?php if ($Page->sortUrl($Page->user_id) == "") { ?>
		<div class="ew-table-header-btn user_new_user_id">
			<span class="ew-table-header-caption"><?php echo $Page->user_id->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer user_new_user_id" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->user_id) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->user_id->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="user_name"><div class="user_new_user_name"><span class="ew-table-header-caption"><?php echo $Page->user_name->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="user_name">
<?php if ($Page->sortUrl($Page->user_name) == "") { ?>
		<div class="ew-table-header-btn user_new_user_name">
			<span class="ew-table-header-caption"><?php echo $Page->user_name->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer user_new_user_name" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->user_name) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->user_name->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="gender"><div class="user_new_gender"><span class="ew-table-header-caption"><?php echo $Page->gender->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="gender">
<?php if ($Page->sortUrl($Page->gender) == "") { ?>
		<div class="ew-table-header-btn user_new_gender">
			<span class="ew-table-header-caption"><?php echo $Page->gender->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer user_new_gender" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->gender) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->gender->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="email_id"><div class="user_new_email_id"><span class="ew-table-header-caption"><?php echo $Page->email_id->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="email_id">
<?php if ($Page->sortUrl($Page->email_id) == "") { ?>
		<div class="ew-table-header-btn user_new_email_id">
			<span class="ew-table-header-caption"><?php echo $Page->email_id->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer user_new_email_id" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->email_id) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->email_id->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="phone_number"><div class="user_new_phone_number"><span class="ew-table-header-caption"><?php echo $Page->phone_number->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="phone_number">
<?php if ($Page->sortUrl($Page->phone_number) == "") { ?>
		<div class="ew-table-header-btn user_new_phone_number">
			<span class="ew-table-header-caption"><?php echo $Page->phone_number->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer user_new_phone_number" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->phone_number) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->phone_number->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="password"><div class="user_new_password"><span class="ew-table-header-caption"><?php echo $Page->password->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="password">
<?php if ($Page->sortUrl($Page->password) == "") { ?>
		<div class="ew-table-header-btn user_new_password">
			<span class="ew-table-header-caption"><?php echo $Page->password->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer user_new_password" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->password) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->password->caption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="pincode"><div class="user_new_pincode"><span class="ew-table-header-caption"><?php echo $Page->pincode->caption() ?></span></div></td>
<?php } else { ?>
	<td data-field="pincode">
<?php if ($Page->sortUrl($Page->pincode) == "") { ?>
		<div class="ew-table-header-btn user_new_pincode">
			<span class="ew-table-header-caption"><?php echo $Page->pincode->caption() ?></span>
		</div>
<?php } else { ?>
		<div class="ew-table-header-btn ew-pointer user_new_pincode" onclick="ew.sort(event,'<?php echo $Page->sortUrl($Page->pincode) ?>',0);">
			<span class="ew-table-header-caption"><?php echo $Page->pincode->caption() ?></span>
...
<?php include "user_new_pager.php" ?>
